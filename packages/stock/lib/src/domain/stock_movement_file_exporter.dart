...
/// Saves a stock movement CSV report and opens it with the system default app.
///
/// On iOS: Files → On My iPhone → Stock Pro → reports.
Future<String?> saveStockMovementCsvAndOpen(String csv) async {
  try {
...
String _buildFileName() {
  ...
  return 'stock_movements_$stamp.csv';
}
